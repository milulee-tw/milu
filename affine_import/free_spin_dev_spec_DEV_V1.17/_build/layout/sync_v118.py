#!/usr/bin/env python3
"""DEV V1.18 → AFFiNE 一鍵同步（內網通了之後直接跑這支）。
...
OLD_BASIS = "依據：規格 DEV V1.17（產品規則沿用 DEV V1.15）"
NEW_BASIS = ("依據：規格 DEV V1.18（新增結算狀態機、注單機制與遊戲端錯誤訊息；"
             "其餘產品規則沿用 DEV V1.15）")
